...
#define DEFAULT_MAX_FEEDRATE          { 150.00, 150.00, 16, 200, 200 }
...
#define DEFAULT_ACCELERATION          2200    // X, Y, Z and E acceleration for printing moves
...
//#define Z_AFTER_HOMING   6      // (mm) Height to move to after homing Z
...
//  #define NOZZLE_PARK_POINT { (X_MIN_POS + 10), (Y_MAX_POS - 10), 4 }
...
#define NOZZLE_CLEAN_FEATURE
  ...
  // Dual hotend system may use { {  -20, (Y_BED_SIZE / 2), (Z_MIN_POS + 1) },  {  20, (Y_BED_SIZE / 2), (Z_MIN_POS + 1) }}
...
#define NEO_PIN             PF13    // (On M5 Connector ) PWM for neo-pixel lights in chamber
// Support for Adafruit NeoPixel LED driver
#define NEOPIXEL_LED
#if ENABLED(NEOPIXEL_LED)
  #define NEOPIXEL_TYPE   NEO_GRB // NEO_GRBW / NEO_GRB - four/three channel driver type (defined in Adafruit_NeoPixel.h)
  #define NEOPIXEL_PIN     NEO_PIN       // LED driving pin
