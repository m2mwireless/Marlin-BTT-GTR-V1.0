...
#define INVERT_E0_DIR true   // E0 is RIGHT side extruder - Labeled Ext 1
#define INVERT_E1_DIR false    // E1 is LEFT  side extruder - Labeled Ext 2
...
#define PREHEAT_1_TEMP_HOTEND 212
