...
#define USE_CONTROLLER_FAN
  ...
  #define CONTROLLERFAN_SPEED_IDLE        15 // (0-255) Idle speed, used when motors are disabled
 ...
 ********************************************************/
  ...
  //#define FAST_PWM_FAN_FREQUENCY 41176
...
#define HOMING_BUMP_DIVISOR { 0, 0, 8 }       // Re-Bump Speed Divisor (Divides the Homing Feedrate)
#define HOMING_BACKOFF_POST_MM { 0, 0, 5 }    // (mm) Backoff from endstops after homing
 ...
 */
 ...
 // #define TOOLCHANGE_PARK
    ...
    #define TOOLCHANGE_PARK_XY_FEEDRATE 9000  // (mm/min)
